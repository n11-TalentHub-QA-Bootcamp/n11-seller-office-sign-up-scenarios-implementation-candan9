...
public class SignUpAsSellerOffice implements Task {
    ...
    public SignUpAsSellerOffice(String user_name, String email_text, String password_text, String store_name_text, String email_retype_text, String password_retype_text, String radio_button) {
